namespace ME.BECS.Editor {
    ...
    public class EntityViewsStaticTracker {
        public static void InitializeViewsTracker() {
            ...
            // ==============================
            // ME.BECS.Tests.Tests_Views+TestViewModule
            {
                var viewInfo = new ViewsTracker.ViewInfo();
                viewInfo.tracker.Resize(1u);
                // ApplyState:
                viewInfo.tracker.Get(0u) = StaticTypes<ME.BECS.Tests.TestComponent>.trackerIndex;
                // [ADD] ME.BECS.Tests.TestComponent + ReadOnly
                // OnUpdate not found
                // OnInitialize not found
                // OnDeInitialize not found
                // OnEnableFromPool not found
                // OnDisableToPool not found
                ViewsTracker.TrackViewModule<ME.BECS.Tests.Tests_Views.TestViewModule>(viewInfo);
            }
            // ==============================
